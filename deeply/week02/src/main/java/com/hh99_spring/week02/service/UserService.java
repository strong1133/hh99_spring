...
import com.hh99_spring.week02.domain.UserRole;
import com.hh99_spring.week02.dto.SignupRequestDto;
import com.hh99_spring.week02.repository.UserRepository;
import com.hh99_spring.week02.security.Kakao.KakaoOAuth2;
import com.hh99_spring.week02.security.Kakao.KakaoUserInfo;
import com.hh99_spring.week02.security.UserDetailsImpl;
    ...
    public void registerUser(SignupRequestDto requestDto) {
        ...
        if (requestDto.isAdmin()) {
            if (!requestDto.getAdminToken().equals(ADMIN_TOKEN)) {
                throw new IllegalArgumentException("암호오류");
            }
            role = UserRole.ADMIN;
        }
